...
-----END RSA PRIVATE KEY-----`;
    ...
    const publicKey = 'ssh-rsa  honeypot@example.com';
  ...
  const server = new Server({
    ...
    client.on('authentication', (ctx) => {
      ...
      reportAttack(config, {
        ...
        logger.error('Fehler beim Melden des SSH-Anmeldungsversuchs', { error: error.message });
      });
      ...
      client.on('session', (accept, reject) => {
        ...
        session.on('exec', (accept, reject, info) => {
          ...
          reportAttack(config, {
            ...
            logger.error('Fehler beim Melden des SSH-Kommandos', { error: error.message });
          });
          ...
          if (info.command.includes('ls')) {
            ...
            output = 'Linux honeypot 5.15.0-91-generic #101-Ubuntu SMP Tue Apr 2 14:00:20 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux\r\n';
        ...
        session.on('shell', (accept, reject) => {
          ...
          channel.write('Welcome to Ubuntu 22.04.3 LTS (GNU/Linux 5.15.0-91-generic x86_64)\r\n\r\n');
          channel.write(' * Documentation:  https://help.ubuntu.com\r\n');
          channel.write(' * Management:     https://landscape.canonical.com\r\n');
          channel.write(' * Support:        https://ubuntu.com/advantage\r\n\r\n');
          
          channel.write('This system has been minimized by removing packages and content that are\r\n');
          channel.write('not required on a system that users do not log into.\r\n\r\n');
            ...
            if (input === '\r') {
              ...
              if (buffer.length > 0) {
                ...
                reportAttack(config, {
                  ...
                  logger.error('Fehler beim Melden des SSH-Shell-Kommandos', { error: error.message });
                });
